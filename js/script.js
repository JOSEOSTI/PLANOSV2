...
//__________________Inicial_MBA3__________________//
...
function draw_coord(dataJson) {
    ...
    if (mensaje) {
        Swal.fire({ icon: 'info', text: mensaje, confirmButtonColor: '#6B949D' });
    }
...
//_________________Metodos de graficar_____________//
...
function crearArea(coords, element, containerSelector) {
    const areaDiv = $("<div class='ubic area-animada'>").css({
        ...
        border: '3px solid rgba(1, 255, 94, 0.7)', // puedes ajustar el color base si quieres,
...
function attachDrawingHandlers(options) {
    ...
    // 🔹 Ajuste para pantallas HD / Retina
    const dpr = window.devicePixelRatio || 1;
    ...
    function startDrawing(e) {
        ...
        state.percent.x1 = coords.x / rect.width;
        state.percent.y1 = coords.y / rect.height;
    }
    ...
    function endDrawing(e) {
        ...
        state.percent.x2 = state.mouseEnd.x / rect.width;
        state.percent.y2 = state.mouseEnd.y / rect.height;
...
//___________Metodos zoom______________//
